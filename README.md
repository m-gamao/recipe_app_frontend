...
and sort your saved recipes alphabetically. There is also a likes counter, where you click an
animated heart to "like" the recipes in the saved folder, and the number of likes get added to the total count for that recipe.
